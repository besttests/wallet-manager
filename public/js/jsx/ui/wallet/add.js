...
snowUI.wallet.add = React.createClass({
	...
	render: function() {
		...
		var walletbuttons = !this.state.key ? '' : (<snowUI.ButtonToolbar><a onClick={snowUI.methods.hrefRoute} href={snowUI.snowPath.root + snowUI.snowPath.wallet + '/' + _this.props.config.wallet + '/backup'}  className="btn btn-default btn-sm pull-left"><span>Backup</span></a>  
						<a onClick={snowUI.methods.hrefRoute} href={snowUI.snowPath.root + snowUI.snowPath.wallet + '/' + _this.props.config.wallet + '/passphrase'}   className="btn btn-default btn-sm pull-left"><span>{changeorencrypt}</span></a><a onClick={snowUI.deleteWallet} data-snowmoon={this.props.config.wally.key} className="btn btn-danger btn-sm pull-right"><span>Delete</span></a></snowUI.ButtonToolbar>)
	    return (
			...
			<form onSubmit={this.walletForm} >
				...
				<div className="col-sm-10 col-sm-offset-1 col-md-10">
					<div className="form-group">
						...
						<a onClick={snowUI.methods.hrefRoute} href={snowUI.snowPath.root + snowUI.snowPath.wallet }  className="btn btn-default btn-sm pull-right"><span>Cancel</span></a> 
						</snowUI.ButtonToolbar >
					</div>
				</div>
				<div className="clearfix"></div>
