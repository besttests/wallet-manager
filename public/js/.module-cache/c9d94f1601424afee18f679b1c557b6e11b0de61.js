...
snowUI.walletSelect = React.createClass({displayName: 'walletSelect',
	...
	render: function() {
		...
		if(this.props.section === snowPath.wallet) {
			var _df = (this.props.wallet && this.props.wallet !== 'new') ? snowPath.wallet + '/' + this.props.wallet : snowPath.wallet;
		} else {
		...
		return this.transferPropsTo(
			React.DOM.div({className: "list"}, 
				...
				React.DOM.select({onChange: this.route, id: "walletselect", value: _df}, 
					wallets, 
					...
					React.DOM.option({value: snowPath.settings}, "settings"), 
						  ...
						  React.DOM.div({className: "wallet"}, 
							React.DOM.div({className: "button-group"}, 
								...
								React.DOM.ul({className: "dropdown-menu", role: "menu"}, 
									React.DOM.li({className: "nav-item-add"}, " ", React.DOM.a({onClick: this.route, href: snowPath.wallet + '/new'}, snowtext.menu.plus.name)), 					
									React.DOM.li({className: "nav-item-home"}, " ", React.DOM.a({onClick: this.route, href: snowPath.wallet}, snowtext.menu.list.name)), 
									React.DOM.li({className: "nav-item-receive"}, React.DOM.a({onClick: this.route, href: snowPath.receive}, snowtext.menu.receive.name)), 
									React.DOM.li({className: "nav-item-settings"}, React.DOM.a({onClick: this.route, href: snowPath.settings}, snowtext.menu.settings.name)), 
