...
var UI = React.createClass({displayName: 'UI',
	...
	render: function() {
		...
		var ssl = this.state.ssl ? {display:'block'} : {}
		
		var lockedwallet = this.state.locked && !this.state.unlocked ? "" : "hidden"
		var openwallet = this.state.locked ? "hidden" : ""
		var unlockedwallet = this.state.unlocked ? "" : "hidden"
		...
		return (
			React.DOM.div({id: "snowpi-body"}, 
				...
				React.DOM.div({id: "walletbar", className: "affix"}, 
					...
					React.DOM.div({style: lockedwallet, id: "wallet-lock", 'data-toggle': "tooltip", 'data-placement': "bottom", alt: "Wallet is encrypted", className: "", title: "Wallet is encrypted"}), 
					
					React.DOM.div({style: openwallet, id: "wallet-unlock", snowlink: "dashboard", 'data-toggle': "tooltip", 'data-placement': "bottom", className: "hidden", title: "You should encrypt this wallet soon."}), 
					
					React.DOM.div({style: unlockedwallet, id: "wallet-unlocked", className: "hidden"}), 
