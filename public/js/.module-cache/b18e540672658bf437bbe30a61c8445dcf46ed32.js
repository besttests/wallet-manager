...
//wallet component
snowUI[snowPath.wallet] = React.createClass({
...
//receive component
snowUI[snowPath.receive] = React.createClass({
	componentDidUpdate: function() {
		this.props.methods.updateState({loading:false});
	},
	render: function() {
...
//settings component
snowUI[snowPath.settings] = React.createClass({
...
//inq component
snowUI[snowPath.inq] = React.createClass({
	componentDidUpdate: function() {
		this.props.methods.updateState({loading:false});
	},
	render: function() {
					...
					React.DOM.div({className: "container-fluid"}, 
						...
						React.DOM.div({className: "dogeboard col-xs-11 col-md-10"}, 
							...
							React.DOM.div({className: "dogeboard-left col-xs-12 col-md-12"}, 
								...
								this.props.section({methods: methods})
							)
						)
					)
				/* end snowpi-body */
