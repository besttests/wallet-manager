...
var UI = React.createClass({displayName: 'UI',
	...
	componentWillReceiveProps: function(nextProps) {
		 ...
		 * 
		 * */
		this.setState({activeMenu:nextProps.activeMenu});
		return false;
	},
	changeTheme: function() {
		console.log(this.props);
		
		UI({activeContent: "SnowpiFlash", children: "Message", showclass: "success"})
	},
	render: function() {
...
React.renderComponent(UI({activeMenu: "SnowpiMan"}), document.getElementById('snowcoins-react'));
