...
var UI = React.createClass({displayName: 'UI',
	getInitialState: function() {
		 ...
		 * */
		return {
			activeMenu:'SnowpiMan',
			activeContent:'SnowpiFlash'
		};
	},
	componentWillReceiveProps: function(nextProps) {
		 ...
		 * 
		 * */
		if(nextProps.activeMenu)this.setState({activeMenu:nextProps.activeMenu});
		if(nextProps.activeContent)this.setState({activeContent:nextProps.activeContent});
		return false;
	},
