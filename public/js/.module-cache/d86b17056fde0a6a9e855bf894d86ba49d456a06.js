...
var UI = React.createClass({displayName: 'UI',
	...
	render: function() {
		...
		var ssl = typeof this.state.wally === 'object' && this.state.isSSL ? {display:'block'} : {display:'none'}
		
		var lockedwallet = typeof this.state.wally === 'object' &&  this.state.locked && !this.state.unlocked ? "" : "hidden"
		var openwallet = typeof this.state.wally !== 'object' || this.state.locked ? "hidden" : ""
		var unlockedwallet = typeof this.state.wally === 'object' &&  this.state.unlocked ? "" : "hidden"
