	...
	render: function() {
		...
		if(this.props.config.mywallets instanceof Array) {
			...
			var mytable = this.props.config.mywallets.map(function (w) {
				return (
					React.DOM.tr(null, 
						React.DOM.td(null, React.DOM.a({onClick: this.menuClick, 'data-snowmoon': snowPath.wallet + '/' + w.key+ '/update'}, React.DOM.span({className: "glyphicon glyphicon-pencil"}, " "))), 
						React.DOM.td(null, React.DOM.a({onClick: this.menuClick, 'data-snowmoon': snowPath.wallet + '/' + w.key+ '/dashboard'},  w.name, " ")), 
						React.DOM.td(null, " ",  w.coin, " "), 
						React.DOM.td(null,  w.host, " "), 
						React.DOM.td(null, w.ssl ? '<span className="glyphicon glyphicon-link" />' : ''), 
						React.DOM.td({onClick: this.deleteWallet, 'data-snowmoon': w.key}, React.DOM.span({style: "cursor:pointer", className: "removewallet text-danger glyphicon glyphicon-remove-sign"}, " "))
					)
				);
			});				
			...
			React.DOM.div(null, 
				React.DOM.table({className: "table table-hover"}, 
					React.DOM.thead(null, 
						React.DOM.tr(null, 
							React.DOM.th(null, React.DOM.span({class: "glyphicon glyphicon-pencil"})), 
							React.DOM.th(null, React.DOM.span({class: "glyphicon glyphicon-sort"}, "name")), 
							React.DOM.th(null, React.DOM.span({class: "glyphicon glyphicon-sort"}, "coin")), 
							React.DOM.th(null, React.DOM.span({class: "glyphicon glyphicon-sort"}, "address")), 
							React.DOM.th({class: "snowsortisempty"}, React.DOM.span({class: "glyphicon glyphicon-sort"}, "ssl")), 
							React.DOM.th(null, React.DOM.span({class: "text-danger glyphicon glyphicon-remove-sign"}))
						)
					), 
