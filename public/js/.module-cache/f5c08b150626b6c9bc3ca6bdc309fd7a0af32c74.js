...
snowUI.walletMenu = React.createClass({displayName: 'walletMenu',
	...
	render: function() {
		var testnet = this.state.config.testnet ? (React.DOM.div({id: "testnet-flash", title: "", 'data-toggle': "tooltip", 'data-placement': "right", 'data-container': "body", class: "dogemenulink", 'data-original-title': "This wallet is on the TESTNET!", style: {display:'block'}}, React.DOM.span({className: "glyphicon glyphicon-text-width"}), " TESTNET ")) : ''
			...
			$.ajax({url: "/api/snowcoins/local/change-wallet"})
				.done(function( resp,status,xhr ) {
					...
					if(this.state.wallet) {
						...
						var newWally = this.state.mywallets[this.state.locatewallet.indexOf(this.state.wallet)];
