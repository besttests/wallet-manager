...
snowUI.walletMenu = React.createClass({displayName: 'walletMenu',
	...
	render: function() {
		var testnet = this.props.testnet ? (React.DOM.div({id: "testnet-flash", title: "", 'data-toggle': "tooltip", 'data-placement': "right", 'data-container': "body", class: "dogemenulink", 'data-original-title': "This wallet is on the TESTNET!", style: {display:'block'}}, React.DOM.span({className: "glyphicon glyphicon-text-width"}), " TESTNET ")) : ''
...
snowUI.receiveMenu = React.createClass({displayName: 'receiveMenu',
	...
	menuClick: function(e) {
		...
		e.preventDefault();
		snowlog.log($(e.target).attr('snowmoon'),$(e.target))
		var moon = $(e.target).attr('snowmoon');
