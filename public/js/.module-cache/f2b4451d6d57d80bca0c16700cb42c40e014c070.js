...
snowUI.loading = React.createClass({displayName: 'loading',
	...
	componentDidMount: function() {
		...
		snowUI.passthrough.loader = function() {
			console.log('loader called',this.state.active)
	...
	render: function() {
	    var loadme = function() {
		console.log('load render',this.state.active)
...
snowUI.wallet = React.createClass({displayName: 'wallet',
	...
	componentDidUpdate: function() {
		console.log('wallet')
		this.props.methods.loader.stop();
	},
	render: function() {
	    return (
		React.DOM.div(null)			
...
var UI = React.createClass({displayName: 'UI',
	...
	componentWillUpdate: function() {
		if(typeof snowUI.passthrough.loader === 'function') snowUI.passthrough.loader()
		return false
	},
	...
	loaderStart: function() {
		if(typeof snowUI.passthrough.loader.start === 'function') snowUI.passthrough.loader.start()
		return false
	},
	loaderStop: function() {
		if(typeof snowUI.passthrough.loader.stop === 'function') snowUI.passthrough.loader.stop()
		return false
	},
