...
snowUI.dashboard = React.createClass({displayName: 'dashboard',
	...
	componentWillReceiveProps: function (nextProps) {
		...
		if(this.props.config.wallet && this.props.config.wallet !== nextProps.config.wallet)this.getData(nextProps,function(resp){_this.setState({data:resp.data,mounted:true,ready:nextProps.ready}) })
