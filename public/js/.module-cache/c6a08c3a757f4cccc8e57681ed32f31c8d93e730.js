...
snowUI.dashboard = React.createClass({displayName: 'dashboard',
	getInitialState: function() {
		var cb = function(ob) { return ob }
		this.getData(function(resp){ 
			return cb({data:resp.data,mounted:false});
		})
	...
	componentWillReceiveProps: function () {
		var _this = this
		//if(this.state.mounted)this.getData(function(resp){_this.setState({data:resp.data}) })
		//this.setState({data:false})
		snowlog.log('dashboard will receive props',this.props)
	},
	componentWillUpdate: function () {
		var _this = this
		//if(!this.state.mounted)this.getData(function(resp){ _this.setState({data:resp.data,mounted:true}) })
		snowlog.log('dashboard will mount',this.props)
	},
	componentDidMount: function() {
	...
	render: function() {
		...
		if(this.state.mounted) {
			...
			snowlog.log('dashboard data',data)
			return (
