...
bone.router({
    routes: addroute,
    overview: function() {
        React.renderComponent(UI({section: snowPath.wallet}), document.getElementById('snowcoins-react'));
    },
    redirect: function() {
    ...
    settings: function(moon) {
        React.renderComponent(UI({section: snowPath.settings, moon: moon}), document.getElementById('snowcoins-react'));
    },
    receive: function(moon) {
        React.renderComponent(UI({section: snowPath.receive, moon: moon}), document.getElementById('snowcoins-react'));
    },
    inqueue: function(moon) {
        React.renderComponent(UI({section: snowPath.inq, moon: moon}), document.getElementById('snowcoins-react'));
    },
