						  ...
						  React.DOM.div({className: "wallet"}, 
							React.DOM.div({className: "button-group"}, 
								...
								React.DOM.ul({className: "dropdown-menu", role: "menu"}, 
									React.DOM.li({className: "nav-item-add"}, " ", React.DOM.a({onClick: this.route, value: snowPath.wallet + '/new'}, snowtext.menu.plus.name)), 					
									React.DOM.li({className: "nav-item-home"}, " ", React.DOM.a({onClick: this.route}, snowtext.menu.list.name)), 
									React.DOM.li({className: "nav-item-receive"}, React.DOM.a({onClick: this.route}, snowtext.menu.receive.name)), 
									React.DOM.li({className: "nav-item-settings"}, React.DOM.a({onClick: this.route}, snowtext.menu.settings.name)), 
