...
var UI = React.createClass({displayName: 'UI',
	...
	componentWillReceiveProps: function(nextProps) {
		...
		if(nextProps.loading) {
			...
			setTimeout(function(){ _this.setState({loading:false}) },15000);
		}
		return false;
	},
	...
	render: function() {
		var loader = this.state.loading ? ReactCSSTransitionGroup({transitionName: "loading", component: snowUI.loading}) :'';
		return this.transferPropsTo(
			React.DOM.div(null, 
