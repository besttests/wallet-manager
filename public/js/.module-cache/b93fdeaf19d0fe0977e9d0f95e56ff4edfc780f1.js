...
snowUI.leftMenu = React.createClass({displayName: 'leftMenu',
	...
	render: function() {
		var menu = this.state.config.section === snowPath.wallet ? snowUI.walletMenu : (this.state.config.section === snowPath.receive || this.state.config.section === snowPath.settings) ? snowUI.receiveMenu : snowUI.defaultMenu
