		 ...
		 * */
		 ...
		 snowUI.methods =  {
			...
			fadeOut: function () {
				...
				$('#maindiv').removeClass('reactfade-enter reactfade-enter-active');
				$('#maindiv').addClass('reactfade-leave reactfade-leave-active');
			},
			fadeIn: function () {
				$('#maindiv').removeClass('reactfade-leave reactfade-leave-active');
				$('#maindiv').addClass('reactfade-enter reactfade-enter-active');
			},
		}
		return {
