...
snowUI.walletMenu = React.createClass({displayName: 'walletMenu',
	...
	menuClick: function(e) {
		...
		e.preventDefault();
		console.log($(e.target).parent()[0].dataset.snowmoon)
...
snowUI.receiveMenu = React.createClass({displayName: 'receiveMenu',
	...
	menuClick: function(e) {
		...
		var moon = $(e.target).parent().dataset.snowmoon;
	...
	render: function() {
		...
		React.DOM.div(null, 
			React.DOM.div({id: "menudcc"}, 
				React.DOM.a({onClick: this.menuClick, 'data-snowmoon': "receive", id: "dogedccsetup", 'data-container': "#menuspy", title: "", className: "dogedccmenulink", 'data-original-title': "Receive coins from strangers. (friends too)"}, " ", React.DOM.span({className: "glyphicon glyphicon-tasks"}), " Receivers"), 
				React.DOM.a({onClick: this.menuClick, 'data-snowmoon': "settings", id: "dogedccsettings", 'data-container': "#menuspy", title: "", className: "dogedccmenulink", 'data-original-title': "Digital Coin Coordinator settings"}, " ", React.DOM.span({className: "glyphicon glyphicon-cog"}), " Settings")
			)
		)			
