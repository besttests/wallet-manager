...
snowUI.walletMenu = React.createClass({displayName: 'walletMenu',
	...
	menuClick: function(e) {
		e.preventDefault();
		console.log($(e.target).parent().attr('ref'))
		var moon = $(e.target).parent().attr('ref');
	...
	render: function() {
		...
		React.DOM.div(null, 
			React.DOM.div({id: "menuwallet"}, 
				React.DOM.a({onClick: this.menuClick, ref: "dashboard", id: "dogedash", 'data-container': "#menuspy", title: "", className: "dogemenulink active", 'data-original-title': "Dashboard"}, " ", React.DOM.span({className: "glyphicon glyphicon-th"}), " Dashboard"), 
				React.DOM.a({onClick: this.menuClick, ref: "accounts", id: "dogeacc", 'data-container': "#menuspy", title: "", className: "dogemenulink", 'data-original-title': "manage wallet accounts"}, " ", React.DOM.span({className: "glyphicon glyphicon-list"}), " Accounts"), 
				React.DOM.a({onClick: this.menuClick, ref: "send", id: "dogesend", 'data-container': "#menuspy", title: "", className: "dogemenulink", 'data-original-title': "send coins"}, " ", React.DOM.span({className: "glyphicon glyphicon-share"}), " Send"), 
				React.DOM.a({onClick: this.menuClick, ref: "transactions", id: "dogetx", 'data-container': "#menuspy", title: "", className: "dogemenulink", 'data-original-title': "sortable transaction list"}, " ", React.DOM.span({className: "glyphicon glyphicon-list-alt"}), " Transactions"), 
				React.DOM.a({onClick: this.menuClick, ref: "update", id: "dogeupdate", 'data-container': "#menuspy", title: "", className: "dogemenulink", 'data-original-title': "update wallet"}, React.DOM.span({className: "glyphicon glyphicon-pencil"}), " Update ", React.DOM.span({id: "updatecoinspan", style: {display:"none"}}))
			), 
"-  ")			
...
snowUI.receiveMenu = React.createClass({displayName: 'receiveMenu',
	...
	menuClick: function(e) {
		e.preventDefault();
		var moon = e.target.ref;
		snowUI.methods.valueRoute(snowPath.root + this.state.config.wallet + '/' + moon);
		return false
	},
	render: function() {
		...
		React.DOM.div(null, 
			React.DOM.div({id: "menudcc"}, 
				React.DOM.a({onClick: this.menuClick, ref: "receive", id: "dogedccsetup", 'data-container': "#menuspy", title: "", className: "dogedccmenulink", 'data-original-title': "Receive coins from strangers. (friends too)"}, " ", React.DOM.span({className: "glyphicon glyphicon-tasks"}), " Receivers"), 
				React.DOM.a({onClick: this.menuClick, ref: "settings", id: "dogedccsettings", 'data-container': "#menuspy", title: "", className: "dogedccmenulink", 'data-original-title': "Digital Coin Coordinator settings"}, " ", React.DOM.span({className: "glyphicon glyphicon-cog"}), " Settings")
			)
		)			
