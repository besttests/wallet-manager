	...
	render: function() {
		...
		React.DOM.div(null, 
			React.DOM.div({id: "menudcc"}, 
				...
				React.DOM.a({onClick: this.menuClick, 'data-snowmoon': snowPath.wallet, id: "dogewallets", 'data-container': "#menuspy", title: "", className: "dogewalletmenulink", 'data-original-title': "Digital Coin Wallets"}, " ", React.DOM.span({className: "glyphicon glyphicon-cog"}), " Wallets"), 
