...
bone.router({
    routes: addroute,
    overview: function() {
        React.renderComponent(UI({section: snowPath.wallet, wallet: snowlog, moon: snowlog}), document.getElementById('snowcoins-react'));
    },
    redirect: function() {
    ...
    wallet: function(wallet,moon) {
        if(!moon)moon = snowlog
        if(!wallet)wallet = snowlog
    ...
    settings: function(moon) {
        React.renderComponent(UI({section: snowPath.settings, wallet: snowlog, moon: moon}), document.getElementById('snowcoins-react'));
    },
    receive: function(moon) {
        React.renderComponent(UI({section: snowPath.receive, wallet: snowlog, moon: moon}), document.getElementById('snowcoins-react'));
    },
    inqueue: function(moon) {
        React.renderComponent(UI({section: snowPath.inq, wallet: snowlog, moon: moon}), document.getElementById('snowcoins-react'));
    },
