	...
	getInitialState: function() {
		 ...
		 * */
		 ...
		 snowUI.methods =  {
			...
			ajax: {
				forcecall: function(type,url,data,callback) {
				...
				post: function(url,data,callback) {
					if(!snowUI.methods.ajax.running) {
						snowUI.methods.ajax.force('POST',url,data,callback)
					} else {
				...
				call: function(url,data,callback) {
					if(!snowUI.methods.ajax.running) {
						snowUI.methods.ajax.force('GET',url,data,callback)
					} else {
						snowmessage('message','call in progress... ' + snowUI.methods.ajax.running,2000)
					}
				},
				callwaiting: function(type,url,data,callback) {
					if(!snowUI.methods.ajax.running) {
						snowUI.methods.ajax.running = url
						snowUI.methods.ajax.force(type,url,data,callback)
					} else {
						snowmessage('message','call in progress... ' + snowUI.methods.ajax.running,2000)
					}
				},
