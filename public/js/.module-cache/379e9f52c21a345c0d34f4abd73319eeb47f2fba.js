	...
	render: function() {
		...
		return this.transferPropsTo(
			React.DOM.div({className: "list"}, 
				...
				React.DOM.select({onChange: this.route, id: "walletselect"}, 
					wallets, 
					React.DOM.optgroup(null), 
					React.DOM.option({value: "/overview"}, "list wallets"), 
					React.DOM.option({value: "/receive"}, "receive coins"), 
					React.DOM.option({value: "/inqueue"}, "inquisive queue")
				)
			)
		);
	}
...
var UI = React.createClass({displayName: 'UI',
	...
	componentWillReceiveProps: function(nextProps) {
		...
		if(nextProps.wallet)this.setState({moon:nextProps.wallet});
		return false;
	},
	...
	render: function() {
		var snowmenu = snowUI[this.state.activeMenu] 
		var snowcontent = snowUI[this.state.activeContent]
		return this.transferPropsTo(
			React.DOM.div(null, 
				React.DOM.div({id: "snowpi-body"}, 
					...
					React.DOM.div({id: "walletbar", className: "affix"}, 
						...
						snowUI.walletSelect(null), 
						React.DOM.div({class: "logo"}, React.DOM.a({title: "inquisive.io snowcoins build info", 'data-container': "body", 'data-placement': "bottom", 'data-toggle': "tooltip", className: "walletbar-logo"}))
...
React.renderComponent(UI(null), document.getElementById('snowcoins-react'));
