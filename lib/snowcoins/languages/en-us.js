var Languages = module.exports = {
		...
		link: {
			...
			title: {
				...
				info: 'A  <a href="https://snowcoins.link/snowcat" target="_blank">.link account</a> gives you shortcut options.  When you link this instance of snowcoins you get a dynamic DNS entry that points to your main IP and a shortcut on the snowcoins.link site. You can optionally use your shortcut to easily share addresses to receive coin and other information. ',
			},
			th: {
				machine: {
					test: 'machine',
			...
			access: {
				nosharekey: {
					text: 'You do not have a .link account set up. <br> You can create a new account at <a href="https://snowcoins.link/snowcat" target="_blank">snowcoins.link</a>',
				},
				addsharekey: {
