var keystone = require('keystone'),
	...
	txitems = keystone.list('TxItems'),
	trackers = keystone.list('Trackers'),
	Wallets = keystone.list('Wallets'),
	ClientConnect = keystone.list('ClientConnect'),
	Attended = keystone.list('Attended'),		
	UnAttended = keystone.list('UnAttended'),
	CurrencyRates = keystone.list('CurrencyRates'),
	Trackers = keystone.list('Trackers');
